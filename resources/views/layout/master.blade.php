...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ url('../../../assets/select/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ url('../../../assets/select/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
</head>
...
<body id="page-top">
    ...
    <script src="../../vendor/jquery/jquery.min.js"></script>
            ...
            <!-- jQuery -->
            <script src="{{ url('assets/select/jquery/jquery.min.js') }}"></script>
            <!-- Select2 -->
            <script src="{{ url('assets/select/select2/js/select2.full.min.js') }}"></script>
            <!-- Page script -->
            <script>
                $(function() {
