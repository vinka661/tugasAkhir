                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter">{{ $konsultasi}}+</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{route ('konsultasi')}}">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">New</div>
                                        <span class="font-weight-bold">Cek dan Balas Konsultasi!</span>
                                    </div>
                                </a>
                            </div>
                        </li>
