                  ...
                  <div class="form-group">
                    ...
                    <div class="d-flex">
                        <div class="custom-control custom-radio mr-3">
                          <input class="custom-control-input" type="radio" id="biru" name="kapsul_vitaminA" value="Biru" required>
                          <label for="biru" class="custom-control-label">Biru</label>
                        </div>
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="merah" name="kapsul_vitaminA" value="Merah" required>
