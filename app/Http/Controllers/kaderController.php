...
class kaderController extends Controller
{
    ...
    public function index()
    {
        ...
        //             ->get();
        return view('operator.kader.index', compact('kader'));
    }
...
// Data bayi dan data timbang 
    ...
    {
        $bayiBalita = BayiBalita::all();
        $user = User::where('role', 'Ibu Bayi')->get();
        return view('kader.timbang.createBB', ['bayiBalita' => $bayiBalita, 'user' => $user]);
    }
    ...
    public function editBB($id_bb)
    {
        ...
        $user = User::where('role', 'Ibu Bayi')->get();
        return view('kader.timbang.editBB', ['bayiBalita' => $bayiBalita, 'user' => $user]);
    }
    ...
    public function detailTimbangBayi($id_bb)
    {
        ...
        $canAdd = Timbang::where('id_bb', $id_bb)
                    ->whereYear('tgl_timbang', now()->year)
                    ->whereMonth('tgl_timbang', now()->month)
                    ->doesntExist();
        return view('kader.timbang.detail', compact('bayiBalita', 'timbang', 'canAdd'));
    }
    ...
    public function updateTimbang(Request $request, $id_timbang)
    {
       ...
       if ($jk == "Perempuan") {
        ...
        $timbang->tinggi_badan = $request->tinggi_badan;
        $timbang->lingkar_kepala = $request->lingkar_kepala;
        $timbang->status_gizi = $q;
        $timbang->save();
